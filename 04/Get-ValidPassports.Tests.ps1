Describe 'Part 1' {
    It 'Returns correct count from example' {
        ...
        $answer = .$PSScriptRoot\Get-ValidPassports.ps1
        $answer | Should -Be 2
    }
...
Describe 'Part 2' {
    It 'Returns correct count from example invalid passports' {
        Mock Get-Content {
            @(
                "eyr:1972 cid:100",
        ...
        $answer = .$PSScriptRoot\Get-ValidPassports.ps1 -CheckValues
        $answer | Should -Be 0
    }

    It 'Returns correct count from example valid passports' {
        Mock Get-Content {
            @(
